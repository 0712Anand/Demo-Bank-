...
import com.bankapp.dto.customer.CustomerUpdateDto;
...
public class AdminServiceImpl implements AdminService {
    ...
    @Transactional
    @Override
    public CustomerDto updateCustomer(Integer customerId, CustomerUpdateDto customerUpdateDto) {
        CustomerEntity customer = customerRepository.findById(customerId)
                .orElseThrow(() -> new ResourceNotFoundException("Customer not found"));

        customer.setCustName(customerUpdateDto.getCustName());
